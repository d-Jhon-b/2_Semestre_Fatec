from atv_1 import contagem_palavras
dicionario_palavras = {}

user_input = ("Python é uma linguagem de programação de alto nível, interpretada e de propósito geral." +
"Criada por Guido van Rossum e lançada pela primeira vez em 1991, a filosofia do Python é enfatizar a legibilidade do código com sua sintaxe simples e fácil de aprender. "+
...
print(contagem_palavras(user_input, dicionario_palavras))
